...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    try {
        ...
        $stmtCheck = $pdo->prepare("SELECT  idMapper, pseudo, mail, mdp , photoProfil FROM Mapper WHERE idMapper = :mapperId");
        ...
        $response = [
            ...
            "mail" => $mapper['mail'],
            "mdp" => $mapper['mdp'], // Masquage du mot de passe pour des raisons de sécurité
